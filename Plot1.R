...
##  produce histogram
par(mfrow=c(1,1))
hist(dataUse$Global_active_power,col = "red",main = "Global Active Power",xlab = "Global Active Power (Kilowatts)",ylim=c(0,1200))

##  copy the graphics device to save to plot1.png
dev.copy(device=png, file ="plot1.png", bg = "transparent")
